...
INSERT INTO QUESTION_MODEL (QUESTION, ANSWERS, DIFFICULTY, CERTIFIED, ID_DISCIPLINE, ID_SUBJECT, AMOUNT_ACCESS, UPDATE_DATE) VALUES ('Porque o código funciona', 'Não sei o motivo exato, mas sei que o stackoverflow sabe', 1, 1, 1, 1, 0, TO_DATE('2023-04-11', 'yyyy-mm-dd'))
INSERT INTO QUESTION_MODEL (QUESTION, ANSWERS, DIFFICULTY, CERTIFIED, ID_DISCIPLINE, ID_SUBJECT, AMOUNT_ACCESS, UPDATE_DATE) VALUES ('Porque o código nunca funciona', 'Não sei o motivo exato, mas sei que o stackoverflow sabe', 2, 1, 3, 2,0,TO_DATE('2023-04-11', 'yyyy-mm-dd'))
...
INSERT INTO QUESTION_MODEL (QUESTION, ANSWERS, DIFFICULTY, CERTIFIED, ID_DISCIPLINE, ID_SUBJECT, AMOUNT_ACCESS, UPDATE_DATE) VALUES ('Porque eu não sei', 'Não sei o motivo exato, mas sei que o stackoverflow sabe', 4, 1, 2, 3,10,TO_DATE('2023-04-11', 'yyyy-mm-dd'))
